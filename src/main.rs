...
fn main() {
    ...
    let mut enigma_machine = Enigma::new(rotor_config,Reflector::from(ReflectorList::A));
    let mut enigma_2 = Enigma::new(rotor_config_2,Reflector::from(ReflectorList::A));
